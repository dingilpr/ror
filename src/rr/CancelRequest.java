...
public class CancelRequest extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			PreparedStatement spd = con.prepareStatement("select * from booking_req where confirmationId = ? and email = ?");
			...
			mailer.sendMail("smtp.gmail.com", "587", "info@sartopartners.com", "info@sartopartners.com", "Sarto Partners", "info@sartopartners.com", "Cancellation Fulfilled",
